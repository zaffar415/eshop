...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<h2 class="text-center"><?php esc_html_e( '', 'woocommerce' ); ?></h2>

	<table cellspacing="0" class="shop_table_responsive" style="border:none;">
		...
		<tr class="order-total" style="border-top:1px solid grey;">
